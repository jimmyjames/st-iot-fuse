...
module.exports = {
    ...
    */
    ...
    /**
     * Executes the specified command on a list of devices.
     * 
     * @param options - an object with the following properties:
     *      devices - an array of devices
     *      capability - the capability of the command to execute
     *      command - the command to execute
     *      controller - the slack controller
     *      user - the slack user
     * 
     * @returns {Array} an array of booleans representing success/failure for commands (one per device)
     */
    actuateDevices: async options => {
        return await Promise.all(
            options.devices.map(async device => {
                // TODO - call actuateDevice with correct arguments
                return await module.exports.actuateDevice({
